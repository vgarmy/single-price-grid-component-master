  ...
  return (
    ...
    >
      <div className='w-full md:w-[635px] h-full md:h-auto flex flex-col md:flex-colums items-center md:p-0 p-10'>
        <div className='py-[40px] px-[40px] rounded-tl-lg rounded-tr-lg bg-white mt-10 mt-0'>
        ...
        <div className='w-full h-full md:h-auto flex flex-col md:flex-row'>
          <div className='w-full md:w-[50%] flex flex-col text-white bg-[var(--Cyan)] py-[40px] px-[40px] rounded-0 md:rounded-bl-lg'>
          ...
          <div className='w-full md:w-[50%] flex flex-col text-white bg-[#4abebd] py-[40px] px-[40px] rounded-br-lg rounded-bl-lg md:rounded-bl-none'>
